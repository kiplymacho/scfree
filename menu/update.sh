...
username=$(curl -sS https://raw.githubusercontent.com/diah082/izinfree/main/ip | grep $MYIP | awk '{print $2}')
valid=$(curl -sS https://raw.githubusercontent.com/diah082/izinfree/main/ip | grep $MYIP | awk '{print $3}')
...
# URL repository
REPO="https://raw.githubusercontent.com/Diah082/scfree/main/"
pwadm="123@Elma!"
